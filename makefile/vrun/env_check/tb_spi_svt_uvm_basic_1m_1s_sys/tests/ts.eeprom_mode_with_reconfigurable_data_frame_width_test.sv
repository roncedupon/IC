 ...
 */
class eeprom_mode_with_reconfigurable_data_frame_width_test extends spi_base_test;
 
  spi_eeprom_virtual_sequence eeprom_virtual_seq;

  /** UVM component utility macro */
  `uvm_component_utils(eeprom_mode_with_reconfigurable_data_frame_width_test)

  /** Class constructor */
  function new(string name = "eeprom_mode_with_reconfigurable_data_frame_width_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    uvm_config_db#(int unsigned)::set(this, "env.sequencer.eeprom_virtual_seq", 
				      "sequence_length", 5);
  ...
  task main_phase(uvm_phase phase);
    ...
    eeprom_virtual_seq = spi_eeprom_virtual_sequence::type_id::create("eeprom_virtual_seq");
 
    if (phase != null)
      phase.raise_objection(this);

    eeprom_virtual_seq.start(env.sequencer);
