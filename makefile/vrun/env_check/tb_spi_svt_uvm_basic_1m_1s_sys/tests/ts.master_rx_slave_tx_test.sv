...
class master_rx_slave_tx_test extends spi_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(master_rx_slave_tx_test)

  /** Class constructor */
  function new(string name = "master_rx_slave_tx_test", uvm_component parent=null);
