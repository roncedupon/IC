...
/**
 * Abstract:
 * class spi_rxonly_sequence is used by the testbench to provide 
 ...
 */
class spi_rxonly_sequence extends uvm_sequence #(svt_spi_transaction);
  ...
  `uvm_object_utils(spi_rxonly_sequence)
  ...
  /** Class constructor */
  function new(string name="spi_rxonly_sequence");
    super.new(name);
  endfunction 
  ...
  virtual task body();
    ...
    for(int i = 0; i < sequence_length; i++) begin
      ...
      `uvm_do_with(req, {transmit_delay == 10;slave_id==0;
       transfer_mode == 2'b01;double_transfer_rate_mode==0;})
