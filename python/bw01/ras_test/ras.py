...
class ras:
    ...
    def calculate_ras(self,weight_matrix=None):
        ...
        for col_index,item in enumerate(parts):
            ...
            self.ST[col_index]=(item/self.g).sum()
        print("\n===================================================")
    ...
    def int8_quantize(self,ras=None):
        ...
        return ras
    def dequantize(self,ras_quanted=None):
        if ras_quanted==None:
            ras_quanted=self.int8_quantize()
        #ras整列求和
        ras_dequanted=(ras_quanted.sum(axis=0))*self.scale
        return ras_dequanted
    
    def calculate_error(self,weight_matrix=None):
        SR=self.dequantize()
        return self.ST-SR
...
if __name__=="__main__":
    ...
    SR=ras_inst.dequantize()
    print(ras_inst.calculate_error())
