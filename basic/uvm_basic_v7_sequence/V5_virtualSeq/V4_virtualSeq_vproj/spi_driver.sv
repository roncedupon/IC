...
class spi_driver extends uvm_driver#(spi_transaction);
    ...
    function new(string name="spi_driver",uvm_component parennt);    
    ...
    extern task drive_one_pkg(spi_transaction tr);
endclass 
...
task spi_driver::drive_one_pkg(spi_transaction tr);
    

    $display("[api driver]%s",tr.tr_name);
