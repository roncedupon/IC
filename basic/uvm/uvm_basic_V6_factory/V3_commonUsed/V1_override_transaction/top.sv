...
module test_top;
  ...
  initial begin
    ...
    uvm_factory::get().set_type_override_by_type(mytransaction::get_type(),mytransaction2::get_type());
    // uvm_factory::get().set_type_override_by_type(mysequence::get_type(),mysequence2::get_type());
    run_test("myenv");
