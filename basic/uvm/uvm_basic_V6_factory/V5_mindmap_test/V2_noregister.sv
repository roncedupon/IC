...
endclass
module top;
    father::type_id father_id;
    son::type_id son_id;
    initial begin
        father_id=new;
        son_id=new;
        uvm_factory::get().set_type_override_by_type(father_id,son_id);
        // uvm_factory::get().set_type_override_by_name("father","son");
    end
    initial begin
