...
import uvm_pkg::*;
//错误描述
//这里是从father里又派生出了一个son2，现在想用son2替换son1，但是这样报了fatal错误
...
class mycase extends uvm_component;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        set_type_override_by_type(son1::get_type(),son2::get_type(),1);//用son2替换son1
        // set_type_override_by_type(father::get_type(),son1::get_type());
        father_inst=father::type_id::create("father_inst");
        // son1_inst=son1::type_id::create("son1_inst");
