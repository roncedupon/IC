 ...
 */
class master_txrx_slave_txrx_with_reconfigurable_data_frame_width_test extends spi_base_test;

  spi_default_virtual_sequence default_virtual_seq;

  /** UVM component utility macro */
  `uvm_component_utils(master_txrx_slave_txrx_with_reconfigurable_data_frame_width_test)

  /** Class constructor */
  function new(string name = "master_txrx_slave_txrx_with_reconfigurable_data_frame_width_test", uvm_component parent=null);
  ...
  task main_phase(uvm_phase phase);
    ...
    default_virtual_seq = spi_default_virtual_sequence::type_id::create("default_virtual_seq");

    if (phase != null)
      phase.raise_objection(this);

    default_virtual_seq.start(env.sequencer);
