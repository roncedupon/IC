...
//--------------------------------------------------------------------------
`ifndef GUARD_SVT_MEM_SA_CORE_2state_SV
...
//----------------------------------------------------------------------
  ...
  function new(
      ...
      inst_handle = svt_mem_sa_inst_new( name, 0, addr_width, phys_dim_nb, max_phys_dim_nb, data_width, attr_width, modes, load_file_name, valid_instance);
  ...
  function svt_mem_sa_core_2state clone( input string name, input longint unsigned sim_time );

    svt_mem_sa_core_2state  clone_inst;
  ...
  //----------------------------------------------------------------------
  function int copy(
      input svt_mem_sa_core_2state src,
  ...
  //----------------------------------------------------------------------
  function svt_mem_backdoor_2state get_backdoor;

    svt_mem_backdoor_2state bd;
    string name;
    int    rc;
    rc = get_name( name ); 
    bd = new( name );
...
//======================================================================
  ...
  function int poke(
    ...
    return svt_mem_sa_inst_poke( inst_handle, addr, data, status, sim_time);
  ...
  function int peek(
    ...
    return svt_mem_sa_inst_peek( inst_handle, addr, data, status, sim_time);
  ...
  function int write(
    ...
    return svt_mem_sa_inst_write( inst_handle, addr, physical_address, data, attrs, status, sim_time);
  ...
  function int write_masked(
    ...
    return svt_mem_sa_inst_write_masked( inst_handle, addr, physical_address, data, mask, attrs, status, sim_time);
  ...
  function int read(
    ...
    data = 0;
    return svt_mem_sa_inst_read( inst_handle, addr, physical_address, data, attrs, status, sim_time);
  ...
  function int get_compare_error(
    ...
    return svt_mem_sa_inst_get_compare_error( inst_handle, error_type, addr, mem_data, file_data );
...
endclass : svt_mem_sa_core_2state
...
//======================================================================
//
// svt_mem_backdoor_2state class -- "backdoor" interface for
// use by models
//
//======================================================================
//======================================================================

class svt_mem_backdoor_2state extends svt_mem_sa_core_2state ;
  ...
  //----------------------------------------------------------------------
  function int copy( input svt_mem_sa_core_2state src,
                     input longint unsigned       dest_adr,
                     input longint unsigned       src_adr,
                     input longint unsigned       length,
                     input longint unsigned       sim_time );
...
endclass : svt_mem_backdoor_2state

`endif // GUARD_SVT_MEM_SA_CORE_2state_SV
`pragma protect begin_protected
`pragma protect encrypt_agent = "Model Technology", encrypt_agent_info = "6.5b"
`pragma protect data_method = "aes128-cbc"
`pragma protect key_keyowner = "Mentor Graphics Corporation" , key_keyname = "MGC-VERIF-SIM-RSA-1" , key_method = "rsa"
`pragma protect key_block encoding = (enctype = "base64")
aSjX+tHN+3OB7qHJ2+BVwpo9C86jBejDrXnOBFBFa/QNRdFL5LfVTAuAW+wb/YkK
zpfpbgSnkM+3Sqd4ErnvKlvXnC5NYlm3RuFJ/pR4lV3H40EeM4uNthRloxW9w5pG
go/pbBDdYBn28HBpP4r+jzbsxzTOD254IVUv+aO4c8U=
`pragma protect data_block encoding = ( enctype = "base64", bytes = 83        )
nj4O5QRum25Hro9E0LOfQi8BcIZhcvYV6p4AE5HYczJtvpj8iNeOP3Z90PBr+WlB
3H7fZVcote8hO8dkqyP6j6aM7wK81dyt7C/V6bd/k9eU3oHLjBx86rVT2jPTF/l2
