...
/**
 * Abstract:
 * class simpleSeq defines a sequence that generates a
...
class simpleSeq extends svt_ahb_master_transaction_base_sequence;

   /** Parameter that controls the number of transactions that will be generated */
   rand int unsigned sequence_length = 10;

  /** UVM Object Utility macro */
  `uvm_object_utils(simpleSeq)
  ...
  /** Class Constructor */
  function new (string name = "simpleSeq");
     super.new(name);
  endfunction : new
