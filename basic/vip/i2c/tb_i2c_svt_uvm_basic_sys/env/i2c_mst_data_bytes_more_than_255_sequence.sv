...
`ifndef GUARD_I2C_MST_DATA_BYTES_MORE_THAN_255_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_DATA_BYTES_MORE_THAN_255_SEQUENCE_UVM_SV
...
class i2c_mst_data_bytes_more_than_255_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_data_bytes_more_than_255_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_data_bytes_more_than_255_sequence");
    super.new(name);
  endfunction : new
...
`endif
  ...
  virtual task body();
    ...
    `uvm_create(tx_xacts_m);
     tx_xacts_m.reasonable_retry_if_nack.constraint_mode(0);
     tx_xacts_m.reasonable_data.constraint_mode(0);
...
endclass : i2c_mst_data_bytes_more_than_255_sequence 

`endif // GUARD_I2C_MST_DATA_BYTES_MORE_THAN_255_SEQUENCE_UVM_SV
