...
`ifndef GUARD_I2C_MST_START_BYTE_WITH_SR_10_BIT_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_START_BYTE_WITH_SR_10_BIT_SEQUENCE_UVM_SV
...
class i2c_mst_start_byte_with_sr_10_bit_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
...
//  svt_i2c_master_transaction tx_xacts_m;
  ...
  `uvm_object_utils(i2c_mst_start_byte_with_sr_10_bit_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_start_byte_with_sr_10_bit_sequence");
    super.new(name);
  endfunction : new
...
endclass: i2c_mst_start_byte_with_sr_10_bit_sequence 

`endif // GUARD_I2C_MST_START_BYTE_WITH_SR_10_BIT_SEQUENCE_UVM_SV
