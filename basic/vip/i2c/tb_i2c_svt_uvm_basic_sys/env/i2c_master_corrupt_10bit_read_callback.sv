...
`ifndef GUARD_I2C_MASTER_CORRUPT_10BIT_READ_CALLBACK_SV
`define GUARD_I2C_MASTER_CORRUPT_10BIT_READ_CALLBACK_SV

/**
 * Abstract: 
 * class 'i2c_master_corrupt_10bit_read_callback' is extended from svt_i2c_master_callback class. 
 * It implements the post_seq_item_get method to set error exception from master.
 * It is used to corrupt first frame of 10bit read command.
 */

class i2c_master_corrupt_10bit_read_callback extends svt_i2c_master_callback;
  ...
  virtual function void post_seq_item_get(svt_i2c_master driver, svt_i2c_master_transaction xact, ref bit drop);
    ...
    exception.error_kind = svt_i2c_master_transaction_exception::CMD_CORRUPT_FOR_10BIT_READ;
...
endclass: i2c_master_corrupt_10bit_read_callback
`endif //GUARD_I2C_MASTER_CORRUPT_10BIT_READ_CALLBACK_SV
