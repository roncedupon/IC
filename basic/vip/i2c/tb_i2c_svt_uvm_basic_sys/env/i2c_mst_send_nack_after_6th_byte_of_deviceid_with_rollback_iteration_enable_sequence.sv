...
`ifndef GUARD_I2C_MST_SEND_NACK_AFTER_6TH_BYTE_OF_DEVICEID_WITH_ROLLBACK_ITERATION_ENABLE_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_SEND_NACK_AFTER_6TH_BYTE_OF_DEVICEID_WITH_ROLLBACK_ITERATION_ENABLE_SEQUENCE_UVM_SV
...
class i2c_mst_send_nack_after_6th_byte_of_deviceid_with_rollback_iteration_enable_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_send_nack_after_6th_byte_of_deviceid_with_rollback_iteration_enable_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_send_nack_after_6th_byte_of_deviceid_with_rollback_iteration_enable_sequence");
    super.new(name);
  endfunction : new
    ...
    `uvm_rand_send(tx_xacts_m, -1,
		       {
		         ...
		         tx_xacts_m.nack_at_device_id_byte == 6;
		         tx_xacts_m.device_id_rollback_iteration == 1;
    ...
    `uvm_rand_send(tx_xacts_m, -1,
		       {
		         ...
		         tx_xacts_m.send_start_byte == 0 ;
		         tx_xacts_m.m_device_id_gen_stop == 0;
		         tx_xacts_m.nack_at_device_id_byte == 10;
		         tx_xacts_m.device_id_rollback_iteration == 4;
...
`endif
    ...
    `uvm_create(tx_xacts_m)
      tx_xacts_m.reasonable_cmd.constraint_mode(0);
      tx_xacts_m.reasonable_m_device_id_gen_stop.constraint_mode(0);
`ifdef SVT_UVM_1800_2_2017_OR_HIGHER
    `uvm_rand_send(tx_xacts_m, -1,
		       {
		         tx_xacts_m.cmd             == I2C_DEVICE_ID; 
		         ...
		         tx_xacts_m.send_start_byte == 0 ;
		         tx_xacts_m.m_device_id_gen_stop == 0;
		         tx_xacts_m.nack_at_device_id_byte == 7;
		         tx_xacts_m.device_id_rollback_iteration == 3;
    ...
    `uvm_rand_send_with(tx_xacts_m, 
		       {
		         ...
		         tx_xacts_m.sr_or_p_gen     == 0 ;
		         tx_xacts_m.send_start_byte == 0 ;
		         tx_xacts_m.m_device_id_gen_stop == 1;
		         tx_xacts_m.nack_at_device_id_byte == 7;
		         tx_xacts_m.device_id_rollback_iteration == 3;
    ...
    `uvm_rand_send(tx_xacts_m, -1,
		       {
		         ...
		         tx_xacts_m.send_start_byte == 0 ;
		         tx_xacts_m.m_device_id_gen_stop == 0;
		         tx_xacts_m.nack_at_device_id_byte == 5;
		         tx_xacts_m.device_id_rollback_iteration == 1;
...
endclass : i2c_mst_send_nack_after_6th_byte_of_deviceid_with_rollback_iteration_enable_sequence 

`endif // GUARD_I2C_MST_SEND_NACK_AFTER_6TH_BYTE_OF_DEVICEID_WITH_ROLLBACK_ITERATION_ENABLE_SEQUENCE_UVM_SV
