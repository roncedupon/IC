...
`ifndef GUARD_I2C_SLV_NACK_FOR_DATA_BYTE_GREATER_THAN_255_SEQUENCE_UVM_SV
`define GUARD_I2C_SLV_NACK_FOR_DATA_BYTE_GREATER_THAN_255_SEQUENCE_UVM_SV
...
class i2c_slv_nack_for_data_byte_greater_than_255_sequence extends uvm_sequence #(svt_i2c_slave_transaction); 
  ...
  `uvm_object_utils(i2c_slv_nack_for_data_byte_greater_than_255_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_slv_nack_for_data_byte_greater_than_255_sequence");
    super.new(name);
  endfunction : new
...
endclass : i2c_slv_nack_for_data_byte_greater_than_255_sequence

`endif // GUARD_I2C_SLV_NACK_FOR_DATA_BYTE_GREATER_THAN_255_SEQUENCE_UVM_SV
