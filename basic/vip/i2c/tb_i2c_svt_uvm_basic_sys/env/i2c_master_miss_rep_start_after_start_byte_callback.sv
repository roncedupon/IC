`ifndef GUARD_I2C_MASTER_MISS_REP_START_AFTER_START_BYTE_CALLBACK_SV
`define GUARD_I2C_MASTER_MISS_REP_START_AFTER_START_BYTE_CALLBACK_SV

/**
 * Abstract: 
 * class 'i2c_master_miss_rep_start_after_start_byte_callback' is extended from svt_i2c_master_callback class. 
 * It implements the post_seq_item_get method to set error exception from master.
 * It is used to corrput the START BYTE frame such that no repeated start will be transmitted after it.
 */

class i2c_master_miss_rep_start_after_start_byte_callback extends svt_i2c_master_callback;
  ...
  virtual function void post_seq_item_get(svt_i2c_master driver, svt_i2c_master_transaction xact, ref bit drop);
    ...
    exception.error_kind = svt_i2c_master_transaction_exception::I2C_MASTER_MISS_SR_AFTER_START_BYTE;
...
endclass: i2c_master_miss_rep_start_after_start_byte_callback
`endif //GUARD_I2C_MASTER_MISS_REP_START_AFTER_START_BYTE_CALLBACK_SV
