...
`ifndef GUARD_I2C_SLV_ERR_SEQUENCE_UVM_SV
`define GUARD_I2C_SLV_ERR_SEQUENCE_UVM_SV
...
class i2c_slv_err_sequence extends uvm_sequence #(svt_i2c_slave_transaction); 
  ...
  `uvm_object_utils(i2c_slv_err_sequence)
...
`endif
  ...
  virtual task body();
    ...
    `uvm_create(tx_xacts_s)  
      ...
      tx_xacts_s.data = new[5];
      tx_xacts_s.data[0] = 'hff;
      tx_xacts_s.do_insert_error = 1;
    `uvm_send(tx_xacts_s)  
