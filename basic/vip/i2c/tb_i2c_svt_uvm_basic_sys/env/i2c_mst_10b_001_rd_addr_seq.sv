...
`ifndef GUARD_I2C_MST_10B_001_RD_ADDR_SEQ_SV
`define GUARD_I2C_MST_10B_001_RD_ADDR_SEQ_SV
...
class i2c_mst_10b_001_rd_addr_seq extends uvm_sequence #(svt_i2c_master_transaction); 

  `uvm_object_utils(i2c_mst_10b_001_rd_addr_seq)
  ...
  function new(string name="i2c_mst_10b_001_rd_addr_seq");
     super.new(name);
  endfunction: new 
...
`endif
    ...
    if (!req.randomize() with
                ...
                `uvm_error("Randomization failure"," i2c_mst_10b_001_rd_addr_seq")
    `uvm_send(req)
...
endclass: i2c_mst_10b_001_rd_addr_seq
`endif //GUARD_I2C_MST_10B_001_RD_ADDR_SEQ_SV
