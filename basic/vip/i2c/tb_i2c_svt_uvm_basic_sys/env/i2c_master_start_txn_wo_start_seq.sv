`ifndef GUARD_I2C_MASTER_START_TXN_WO_START_SEQ_UVM_SV
`define GUARD_I2C_MASTER_START_TXN_WO_START_SEQ_UVM_SV
...
class i2c_master_start_txn_wo_start_seq extends uvm_sequence #(svt_i2c_master_transaction); 
...
//  svt_i2c_master_transaction tx_xacts_m;
  ...
  `uvm_object_utils(i2c_master_start_txn_wo_start_seq)
  ...
  /** Class constructor */
  function new (string name = "i2c_master_start_txn_wo_start_seq");
    super.new(name);
  endfunction : new
...
endclass: i2c_master_start_txn_wo_start_seq 

`endif // GUARD_I2C_MASTER_START_TXN_WO_START_SEQ_UVM_SV
