`ifndef GUARD_I2C_MASTER_MISS_REP_START_AFTER_START_BYTE_WITH_HS_MODE_SEQ_UVM_SV
`define GUARD_I2C_MASTER_MISS_REP_START_AFTER_START_BYTE_WITH_HS_MODE_SEQ_UVM_SV
...
class i2c_master_miss_rep_start_after_start_byte_with_hs_mode_seq extends uvm_sequence #(svt_i2c_master_transaction); 
...
//  svt_i2c_master_transaction tx_xacts_m;
  ...
  `uvm_object_utils(i2c_master_miss_rep_start_after_start_byte_with_hs_mode_seq)
  ...
  /** Class constructor */
  function new (string name = "i2c_master_miss_rep_start_after_start_byte_with_hs_mode_seq");
    super.new(name);
  endfunction : new
...
endclass: i2c_master_miss_rep_start_after_start_byte_with_hs_mode_seq 

`endif // GUARD_I2C_MASTER_MISS_REP_START_AFTER_START_BYTE_WITH_HS_MODE_SEQ_UVM_SV
