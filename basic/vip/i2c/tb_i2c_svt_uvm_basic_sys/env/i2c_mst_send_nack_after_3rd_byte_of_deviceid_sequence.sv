...
`ifndef GUARD_I2C_MST_SEND_NACK_AFTER_3RD_BYTE_OF_DEVICEID_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_SEND_NACK_AFTER_3RD_BYTE_OF_DEVICEID_SEQUENCE_UVM_SV
...
class i2c_mst_send_nack_after_3rd_byte_of_deviceid_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_send_nack_after_3rd_byte_of_deviceid_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_send_nack_after_3rd_byte_of_deviceid_sequence");
    super.new(name);
  endfunction : new
...
endclass : i2c_mst_send_nack_after_3rd_byte_of_deviceid_sequence 

`endif // GUARD_I2C_MST_SEND_NACK_AFTER_3RD_BYTE_OF_DEVICEID_SEQUENCE_UVM_SV
