...
`ifndef GUARD_I2C_MASTER_WRITE_TWO_BYTE_SEQUENCE_SV
`define GUARD_I2C_MASTER_WRITE_TWO_BYTE_SEQUENCE_SV
...
class i2c_master_write_two_byte_sequence extends uvm_sequence #(svt_i2c_master_transaction); 

  `uvm_object_utils(i2c_master_write_two_byte_sequence)
  ...
  function new(string name="i2c_master_write_two_byte_sequence");
     super.new(name);
  endfunction: new 
...
endclass: i2c_master_write_two_byte_sequence
`endif //GUARD_I2C_MASTER_WRITE_TWO_BYTE_SEQUENCE_SV
