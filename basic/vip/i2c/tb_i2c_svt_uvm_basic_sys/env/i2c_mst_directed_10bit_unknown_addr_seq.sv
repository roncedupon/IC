`ifndef GUARD_I2C_MST_DIRECTED_10BIT_UNKNOWN_ADDR_SEQ_UVM_SV
`define GUARD_I2C_MST_DIRECTED_10BIT_UNKNOWN_ADDR_SEQ_UVM_SV
...
class i2c_mst_directed_10bit_unknown_addr_seq extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_directed_10bit_unknown_addr_seq)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_directed_10bit_unknown_addr_seq");
    super.new(name);
  endfunction : new
...
`endif
    ...
    if (!req.randomize() with
                ...
                `uvm_error("Randomization failure"," i2c_mst_directed_10bit_unknown_addr_seq")
    `uvm_send(req)
...
endclass : i2c_mst_directed_10bit_unknown_addr_seq 
