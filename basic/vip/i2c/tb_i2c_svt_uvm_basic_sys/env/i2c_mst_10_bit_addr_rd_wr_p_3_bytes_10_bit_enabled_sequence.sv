...
`ifndef GUARD_I2C_MST_10_BIT_ADDR_RD_WR_P_3_BYTES_10_BIT_ENABLED_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_10_BIT_ADDR_RD_WR_P_3_BYTES_10_BIT_ENABLED_SEQUENCE_UVM_SV
...
class i2c_mst_10_bit_addr_rd_wr_p_3_bytes_10_bit_enabled_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_10_bit_addr_rd_wr_p_3_bytes_10_bit_enabled_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_10_bit_addr_rd_wr_p_3_bytes_10_bit_enabled_sequence");
    super.new(name);
  endfunction : new
...
endclass: i2c_mst_10_bit_addr_rd_wr_p_3_bytes_10_bit_enabled_sequence 

`endif // GUARD_I2C_MST_10_BIT_ADDR_RD_WR_P_3_BYTES_10_BIT_ENABLED_SEQUENCE_UVM_SV
