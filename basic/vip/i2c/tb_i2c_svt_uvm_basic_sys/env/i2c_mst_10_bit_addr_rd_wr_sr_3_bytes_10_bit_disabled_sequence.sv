...
`ifndef GUARD_I2C_MST_10_BIT_ADDR_RD_WR_SR_3_BYTES_10_BIT_DISABLED_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_10_BIT_ADDR_RD_WR_SR_3_BYTES_10_BIT_DISABLED_SEQUENCE_UVM_SV
...
class i2c_mst_10_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_sequence extends uvm_sequence #(svt_i2c_master_transaction); 

  svt_i2c_master_transaction tx_xacts_m;

  /** I2C configuration handle */ 
  cust_svt_i2c_system_configuration i2c_cfg;

  /** UVM object utility macro */
  `uvm_object_utils(i2c_mst_10_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_10_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_sequence");
    super.new(name);
  endfunction : new
...
endclass: i2c_mst_10_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_sequence 

`endif // GUARD_I2C_MST_10_BIT_ADDR_RD_WR_SR_3_BYTES_10_BIT_DISABLED_SEQUENCE_UVM_SV
