...
`ifndef GUARD_I2C_MST_DIRECTED_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_DIRECTED_SEQUENCE_UVM_SV
...
class i2c_mst_directed_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_directed_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_directed_sequence");
    super.new(name);
  endfunction : new
