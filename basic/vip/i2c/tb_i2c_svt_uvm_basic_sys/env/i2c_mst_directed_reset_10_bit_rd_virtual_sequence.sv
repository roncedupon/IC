...
`ifndef GUARD_I2C_MST_DIRECTED_RESET_10_BIT_RD_VIRTUAL_SEQUENCE_SV
`define GUARD_I2C_MST_DIRECTED_RESET_10_BIT_RD_VIRTUAL_SEQUENCE_SV
class i2c_mst_directed_reset_10_bit_rd_virtual_sequence extends uvm_sequence;

  /** Sequence Length in Virtual Sequence, to set to the actual default sequence */
  int unsigned sequence_length = 10;

  /** UVM object utility macro */
  `uvm_object_utils(i2c_mst_directed_reset_10_bit_rd_virtual_sequence)
...
//  `uvm_declare_p_sequencer(svt_i2c_system_sequencer)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_directed_reset_10_bit_rd_virtual_sequence");
    super.new(name);
  endfunction : new
...
endclass : i2c_mst_directed_reset_10_bit_rd_virtual_sequence 

`endif // GUARD_I2C_MST_DIRECTED_RESET_10_BIT_RD_VIRTUAL_SEQUENCE_SV
