...
`ifndef GUARD_I2C_MST_START_BYTE_WITH_REPEATED_START_10BIT_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_START_BYTE_WITH_REPEATED_START_10BIT_SEQUENCE_UVM_SV
...
class i2c_mst_start_byte_with_repeated_start_10bit_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
...
//  svt_i2c_master_transaction tx_xacts_m;
  ...
  `uvm_object_utils(i2c_mst_start_byte_with_repeated_start_10bit_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_start_byte_with_repeated_start_10bit_sequence");
    super.new(name);
  endfunction : new
...
`uvm_create(tx_xacts_m);
    ...
    tx_xacts_m.reasonable_send_start_byte.constraint_mode(0);
    ...
    for (int i = 0; i < 1000; i = i+1) begin
      ...
      tx_xacts_m.reasonable_addr_10bit.constraint_mode(0);
      tx_xacts_m.reasonable_cmd.constraint_mode(0);
      tx_xacts_m.reasonable_send_3_bytes_10b_slv_sr_rd.constraint_mode(0);
      `uvm_rand_send(tx_xacts_m, -1,
        	       {
        	         tx_xacts_m.cmd               inside {I2C_WRITE, I2C_READ}; // Randomize
        	         tx_xacts_m.addr              ==`SVT_I2C_SLAVE0_ADDRESS;
        	         tx_xacts_m.data.size()       == 4;
        	         //tx_xacts_m.sr_or_p_gen     == 1; // Randomize
        	         tx_xacts_m.addr_10bit        == 1;
        	         //tx_xacts_m.send_start_byte == 1; // Randomize
        	       })
    end
    `uvm_create(tx_xacts_m);
    //reasonable_sr_or_p_gen
...
endclass: i2c_mst_start_byte_with_repeated_start_10bit_sequence 

`endif // GUARD_I2C_MST_START_BYTE_WITH_REPEATED_START_10BIT_SEQUENCE_UVM_SV
