...
`ifndef GUARD_I2C_MST_GENERATE_STOP_INSTED_OF_REPEATEDSTART_AFTER_10BIT_SLAVE_ADDRESS_DEVICEID_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_GENERATE_STOP_INSTED_OF_REPEATEDSTART_AFTER_10BIT_SLAVE_ADDRESS_DEVICEID_SEQUENCE_UVM_SV
...
class i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_sequence");
    super.new(name);
  endfunction : new
...
endclass : i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_sequence 

`endif // GUARD_I2C_MST_GENERATE_STOP_INSTED_OF_REPEATEDSTART_AFTER_10BIT_SLAVE_ADDRESS_DEVICEID_SEQUENCE_UVM_SV
