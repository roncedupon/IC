...
`ifndef GUARD_I2C_SLV_NACK_DATA_SEQUENCE_UVM_SV
`define GUARD_I2C_SLV_NACK_DATA_SEQUENCE_UVM_SV
...
class i2c_slv_nack_data_sequence extends uvm_sequence #(svt_i2c_slave_transaction); 
  ...
  `uvm_object_utils(i2c_slv_nack_data_sequence)
...
endclass : i2c_slv_nack_data_sequence 

`endif // GUARD_I2C_SLV_NACK_DATA_SEQUENCE_UVM_SV
