...
`ifndef GUARD_I2C_MST_SEND_NACK_AFTER_2ND_BYTE_OF_DEVICEID_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_SEND_NACK_AFTER_2ND_BYTE_OF_DEVICEID_SEQUENCE_UVM_SV
...
class i2c_mst_send_nack_after_2nd_byte_of_deviceid_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_send_nack_after_2nd_byte_of_deviceid_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_send_nack_after_2nd_byte_of_deviceid_sequence");
    super.new(name);
  endfunction : new
    ...
    `uvm_rand_send(tx_xacts_m, -1,
		       {
		         ...
		         tx_xacts_m.nack_at_device_id_byte == 2;
...
endclass : i2c_mst_send_nack_after_2nd_byte_of_deviceid_sequence 

`endif // GUARD_I2C_MST_SEND_NACK_AFTER_2ND_BYTE_OF_DEVICEID_SEQUENCE_UVM_SV
