...
`ifndef GUARD_I2C_MST_DIRECTED_RESET_IN_TEN_BIT_RD_SEQUENCE_UVM_SV
`define GUARD_I2C_MST_DIRECTED_RESET_IN_TEN_BIT_RD_SEQUENCE_UVM_SV

/** This sequence demonstrates, the way user can control the subset of 
 ...
 */
class i2c_mst_directed_reset_in_ten_bit_rd_sequence extends uvm_sequence #(svt_i2c_master_transaction); 
  ...
  `uvm_object_utils(i2c_mst_directed_reset_in_ten_bit_rd_sequence)
  ...
  /** Class constructor */
  function new (string name = "i2c_mst_directed_reset_in_ten_bit_rd_sequence");
    super.new(name);
  endfunction : new
...
endclass: i2c_mst_directed_reset_in_ten_bit_rd_sequence 

`endif // GUARD_I2C_MST_DIRECTED_RESET_IN_TEN_BIT_RD_SEQUENCE_UVM_SV
