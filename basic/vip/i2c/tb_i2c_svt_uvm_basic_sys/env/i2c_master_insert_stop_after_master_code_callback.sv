`ifndef GUARD_I2C_MASTER_INSERT_STOP_AFTER_MASTER_CODE_CALLBACK_SV
`define GUARD_I2C_MASTER_INSERT_STOP_AFTER_MASTER_CODE_CALLBACK_SV

/**
 * Abstract: 
 * class 'i2c_master_insert_stop_after_master_code_callback' is extended from svt_i2c_master_callback class. 
...
class i2c_master_insert_stop_after_master_code_callback extends svt_i2c_master_callback;
  ...
  virtual function void post_seq_item_get(svt_i2c_master driver, svt_i2c_master_transaction xact, ref bit drop);
    ...
    exception.error_kind = svt_i2c_master_transaction_exception::I2C_INSERT_P_AFTER_MASTER_CODE;
...
endclass: i2c_master_insert_stop_after_master_code_callback
`endif //GUARD_I2C_MASTER_INSERT_STOP_AFTER_MASTER_CODE_CALLBACK_SV
