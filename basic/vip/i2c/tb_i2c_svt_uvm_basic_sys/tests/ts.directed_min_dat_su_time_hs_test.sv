...
`include "i2c_mst_directed_sequence.sv"
`include "i2c_slv_directed_sequence.sv"
`include "i2c_null_virtual_sequence.sv"

class directed_min_dat_su_time_hs_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(directed_min_dat_su_time_hs_test)

  /** Class constructor */
  function new(string name = "directed_min_dat_su_time_hs_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    cfg.set_bus_speed(HIGHSPEED_MODE);                           // Set Bus-Speed
    cfg.master_cfg[0].scl_low_time_offset_hs = 10;         
    cfg.master_cfg[0].sda_rise_time_hs  = 80;         
    cfg.master_cfg[0].sda_fall_time_hs  = 80;         
    cfg.master_cfg[0].hd_dat_time_hs    = 70;         
    cfg.master_cfg[0].su_dat_time_hs    = 10;         
    cfg.master_cfg[0].min_hd_dat_time_fs = 0;

    cfg.slave_cfg[0].scl_low_time_offset_hs = 10;         
    cfg.slave_cfg[0].sda_rise_time_hs   = 80;         
    cfg.slave_cfg[0].sda_fall_time_hs   = 80;         
    cfg.slave_cfg[0].hd_dat_time_hs     = 70;         
    cfg.slave_cfg[0].su_dat_time_hs     = 10;         
    cfg.slave_cfg[0].min_hd_dat_time_fs = 0;
  ...
  task disable_error();
    ...
    env.i2c_system_env.master[0].monitor.err_check.i2c_invalid_master_id_transmit_speed.set_default_fail_effect(svt_err_check_stats::NOTE);
    ...
    env.i2c_system_env.slave[0].monitor.err_check.i2c_invalid_master_id_transmit_speed.set_default_fail_effect(svt_err_check_stats::NOTE);
