...
`include "i2c_mst_send_wr_rd_device_id_with_unknown_addr_seq.sv"
`include "i2c_slv_directed_sequence.sv"
`include "i2c_null_virtual_sequence.sv"

class i2c_mst_send_wr_rd_device_id_with_unknown_addr_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_mst_send_wr_rd_device_id_with_unknown_addr_test)

  /** Class constructor */
  function new(string name = "i2c_mst_send_wr_rd_device_id_with_unknown_addr_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   /** Disable the virtual default sequence on the the virtual sequencer started in the i2c_base_test */
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_mst_send_wr_rd_device_id_with_unknown_addr_seq::type_id::get());
