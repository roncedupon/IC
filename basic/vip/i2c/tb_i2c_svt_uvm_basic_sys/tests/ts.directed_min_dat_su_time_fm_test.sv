...
class directed_min_dat_su_time_fm_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(directed_min_dat_su_time_fm_test)

  /** Class constructor */
  function new(string name = "directed_min_dat_su_time_fm_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    cfg.set_bus_speed(FAST_MODE_PLUS);                           // Set Bus-Speed
    cfg.master_cfg[0].scl_low_time_offset_fm_plus = 0;         
    cfg.master_cfg[0].sda_rise_time_fm_plus  = 120;         
    cfg.master_cfg[0].sda_fall_time_fm_plus  = 120;         
    cfg.master_cfg[0].hd_dat_time_fm_plus    = 330;         
    cfg.master_cfg[0].su_dat_time_fm_plus    = 50;         

    cfg.slave_cfg[0].scl_low_time_offset_fm_plus = 0;         
    cfg.slave_cfg[0].sda_rise_time_fm_plus   = 120;         
    cfg.slave_cfg[0].sda_fall_time_fm_plus   = 120;         
    cfg.slave_cfg[0].hd_dat_time_fm_plus     = 330;         
    cfg.slave_cfg[0].su_dat_time_fm_plus     = 50;         
