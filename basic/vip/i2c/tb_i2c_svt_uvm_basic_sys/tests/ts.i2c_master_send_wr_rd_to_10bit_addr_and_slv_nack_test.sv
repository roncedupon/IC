...
`include "i2c_default_mst_10bit_sequence.sv"
`include "i2c_slave_nack_for_2nd_phase_of_10bit_addr_callback.sv"

class i2c_master_send_wr_rd_to_10bit_addr_and_slv_nack_test extends i2c_base_test;

  i2c_slave_nack_for_2nd_phase_of_10bit_addr_callback cust_callback;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_master_send_wr_rd_to_10bit_addr_and_slv_nack_test)

  /** Class constructor */
  function new(string name = "i2c_master_send_wr_rd_to_10bit_addr_and_slv_nack_test", uvm_component parent=null);
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the i2c_master_send_wr_rd_to_10bit_addr_and_slv_nack_test"), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
