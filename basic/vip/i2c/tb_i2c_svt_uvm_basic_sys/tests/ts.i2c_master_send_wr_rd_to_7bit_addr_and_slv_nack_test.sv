...
`include "i2c_slv_nack_sequence.sv"

class i2c_master_send_wr_rd_to_7bit_addr_and_slv_nack_test extends i2c_base_test;


  /** UVM component utility macro */
  `uvm_component_utils(i2c_master_send_wr_rd_to_7bit_addr_and_slv_nack_test)

  /** Class constructor */
  function new(string name = "i2c_master_send_wr_rd_to_7bit_addr_and_slv_nack_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_default_mst_sequence::type_id::get());
 
   /** Apply the slave directed i2c sequence to the i2c slave sequencer */
   uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.slave[0].sequencer.main_phase", "default_sequence", i2c_slv_nack_sequence::type_id::get());
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the i2c_master_send_wr_rd_to_7bit_addr_and_slv_nack_test"), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
  ...
  endtask : main_phase
   ...
   function void disable_error();
    env.i2c_system_env.master[0].monitor.err_check.i2c_slave_to_issue_address_ack.set_default_fail_effect(svt_err_check_stats::NOTE);
    env.i2c_system_env.slave[0].monitor.err_check.i2c_slave_to_issue_address_ack.set_default_fail_effect(svt_err_check_stats::NOTE);
