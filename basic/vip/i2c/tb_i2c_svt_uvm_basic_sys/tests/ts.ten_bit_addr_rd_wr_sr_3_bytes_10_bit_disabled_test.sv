...
`include "i2c_mst_10_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_sequence.sv"
`include "i2c_slv_directed_sequence.sv"
`include "i2c_null_virtual_sequence.sv"
class ten_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(ten_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_test)

  /** Class constructor */
  function new(string name = "ten_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   /** Apply the master directed i2c sequence to the i2c master sequencer */
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_mst_10_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_sequence::type_id::get());
    //uvm_config_db#(cust_svt_i2c_system_configuration)::set(this, "env.i2c_system_env.master[0].sequencer", "cfg", cfg);
    uvm_config_db#(bit [9:0])::set(this, "env.i2c_system_env.master[0].sequencer.i2c_mst_10_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_sequence", "address", cfg.slave_cfg[0].slave_address);
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the ten_bit_addr_rd_wr_sr_3_bytes_10_bit_disabled_test "), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
