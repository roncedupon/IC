...
`include "i2c_mst_10b_0f7_rd_addr_seq.sv"
`include "i2c_slave_user_conf_sequence.sv"
`include "i2c_null_virtual_sequence.sv"

class i2c_mst_10_bit_0f7_read_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_mst_10_bit_0f7_read_test)

  /** Class constructor */
  function new(string name = "i2c_mst_10_bit_0f7_read_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    cfg.slave_cfg[0].slave_address =  'h0f7;                       // disable 10-bit Addressing
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_mst_10b_0f7_rd_addr_seq::type_id::get());
