...
`include "i2c_mst_directed_reset_10_bit_rd_virtual_sequence.sv"
class directed_reset_in_ten_bit_rd_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(directed_reset_in_ten_bit_rd_test)

  /** Class constructor */
  function new(string name = "directed_reset_in_ten_bit_rd_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   /** Disable the virtual default sequence on the the virtual sequencer started in the i2c_base_test */
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.sequencer.main_phase", "default_sequence", i2c_mst_directed_reset_10_bit_rd_virtual_sequence::type_id::get());
 uvm_config_db#(bit [9:0])::set(this, "env.i2c_system_env.master[0].sequencer.i2c_mst_directed_reset_in_ten_bit_rd_sequence", "address", cfg.slave_cfg[0].slave_address);
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the directed_reset_in_ten_bit_rd_test"), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
