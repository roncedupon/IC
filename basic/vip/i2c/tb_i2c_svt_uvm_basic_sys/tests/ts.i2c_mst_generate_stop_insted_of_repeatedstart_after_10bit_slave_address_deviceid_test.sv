...
class i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_test)

  /** Class constructor */
  function new(string name = "i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    super.build_phase(phase);
     cfg.master_cfg[0].enable_10bit_addr  =  1;
   ...
   /** Disable the virtual default sequence on the the virtual sequencer started in the i2c_base_test */
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_mst_generate_stop_insted_of_repeatedstart_after_10bit_slave_address_deviceid_sequence::type_id::get());
