...
class i2c_master_send_cbus_addr_and_found_ack_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_master_send_cbus_addr_and_found_ack_test)


  /** Class constructor */
  function new(string name = "i2c_master_send_cbus_addr_and_found_ack_test", uvm_component parent=null);
