...
`include "i2c_master_start_txn_wo_start_seq.sv"
`include "i2c_slv_directed_sequence.sv"
`include "i2c_null_virtual_sequence.sv"
`include "i2c_master_started_transction_without_issuing_start_pulse_callback.sv"

class i2c_master_start_txn_wo_start_test extends i2c_base_test;

  i2c_master_started_transction_without_issuing_start_pulse_callback cust_callback;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_master_start_txn_wo_start_test)

  /** Class constructor */
  function new(string name = "i2c_master_start_txn_wo_start_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_master_start_txn_wo_start_seq::type_id::get());
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the i2c_master_start_txn_wo_start_test"), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
  ...
  endtask : main_phase
   ...
   //3. i2c_transaction_started_without_a_start_pulse: Error for no start.
   function void disable_error();
    ...
    env.i2c_system_env.master[0].monitor.err_check.i2c_transaction_started_without_a_start_pulse.set_default_fail_effect(svt_err_check_stats::NOTE);
    ...
    env.i2c_system_env.slave[0].monitor.err_check.i2c_transaction_started_without_a_start_pulse.set_default_fail_effect(svt_err_check_stats::NOTE);
