...
`include "i2c_mst_start_byte_with_sr_10_bit_sequence.sv"
`include "i2c_slv_random_sequence.sv"
`include "i2c_null_virtual_sequence.sv"

class start_byte_in_hs_mode_10_bit_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(start_byte_in_hs_mode_10_bit_test)

  /** Class constructor */
  function new(string name = "start_byte_in_hs_mode_10_bit_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_mst_start_byte_with_sr_10_bit_sequence::type_id::get());
   ...
   uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.slave[0].sequencer.main_phase", "default_sequence", i2c_slv_random_sequence::type_id::get());
    ...
    uvm_config_db#(int unsigned)::set(this, "env.i2c_system_env.master[0].sequencer.i2c_mst_start_byte_with_sr_10_bit_sequence", "sequence_length", 1);
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the start_byte_in_hs_mode_10_bit_test"), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
