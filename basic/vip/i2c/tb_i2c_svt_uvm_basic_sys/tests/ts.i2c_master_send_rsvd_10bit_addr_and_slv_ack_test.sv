...
`include "i2c_mst_directed_10bit_unknown_addr_seq.sv"
`include "i2c_slv_err_sequence.sv"
`include "i2c_null_virtual_sequence.sv"

class i2c_master_send_rsvd_10bit_addr_and_slv_ack_test extends i2c_base_test;

  i2c_slave_ack_for_reserved_address_callback cust_callback;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_master_send_rsvd_10bit_addr_and_slv_ack_test)

  /** Class constructor */
  function new(string name = "i2c_master_send_rsvd_10bit_addr_and_slv_ack_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    cfg.slave_cfg[0].slave_address = 10'b11_0000_1111;
   ...
   uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_mst_directed_10bit_unknown_addr_seq::type_id::get());
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the i2c_master_send_rsvd_10bit_addr_and_slv_ack_test"), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
