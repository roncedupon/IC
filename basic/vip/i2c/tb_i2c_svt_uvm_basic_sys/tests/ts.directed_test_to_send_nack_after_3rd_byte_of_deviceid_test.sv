 ...
 * A simple directed test showcases the use of the i2c_mst_send_nack_after_3rd_byte_of_deviceid_sequence sequence.
...
class directed_test_to_send_nack_after_3rd_byte_of_deviceid_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(directed_test_to_send_nack_after_3rd_byte_of_deviceid_test)

  /** Class constructor */
  function new(string name = "directed_test_to_send_nack_after_3rd_byte_of_deviceid_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   /** Disable the virtual default sequence on the the virtual sequencer started in the i2c_base_test */
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.master[0].sequencer.main_phase", "default_sequence", i2c_mst_send_nack_after_3rd_byte_of_deviceid_sequence::type_id::get());
