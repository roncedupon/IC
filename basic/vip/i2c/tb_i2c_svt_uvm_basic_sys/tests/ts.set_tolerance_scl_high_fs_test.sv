...
class set_tolerance_scl_high_fs_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(set_tolerance_scl_high_fs_test)

  /** Class constructor */
  function new(string name = "set_tolerance_scl_high_fs_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    cfg.master_cfg[0].bus_speed                   = FAST_MODE;
    cfg.slave_cfg[0].bus_speed                    = FAST_MODE;
  ...
  task main_phase(uvm_phase phase);
    ...
    `uvm_info("main_phase", $sformatf("Setting the drain time in the main_phase of the set_tolerance_scl_high_fs_test"), UVM_NONE) 
      `ifdef SVT_UVM_1800_2_2017_OR_HIGHER
