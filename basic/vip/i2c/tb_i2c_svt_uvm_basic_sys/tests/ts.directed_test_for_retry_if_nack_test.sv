...
`include "i2c_slv_nack_address_sequence.sv"
`include "i2c_null_virtual_sequence.sv"

class directed_test_for_retry_if_nack_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(directed_test_for_retry_if_nack_test)

  /** Class constructor */
  function new(string name = "directed_test_for_retry_if_nack_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   /** Disable the virtual default sequence on the the virtual sequencer started in the i2c_base_test */
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_system_env.slave[0].sequencer.main_phase", "default_sequence", i2c_slv_nack_address_sequence::type_id::get());
