...
class directed_min_dat_su_time_ss_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(directed_min_dat_su_time_ss_test)

  /** Class constructor */
  function new(string name = "directed_min_dat_su_time_ss_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    cfg.master_cfg[0].scl_low_time_offset_ss = 0;         
    cfg.master_cfg[0].sda_rise_time_ss  = 1000;         
    cfg.master_cfg[0].sda_fall_time_ss  = 300;         
    cfg.master_cfg[0].hd_dat_time_ss    = 3450;         
    cfg.master_cfg[0].su_dat_time_ss    = 250;         

    cfg.slave_cfg[0].scl_low_time_offset_ss = 0;         
    cfg.slave_cfg[0].sda_rise_time_ss   = 1000;         
    cfg.slave_cfg[0].sda_fall_time_ss   = 300;         
    cfg.slave_cfg[0].hd_dat_time_ss     = 3450;         
    cfg.slave_cfg[0].su_dat_time_ss     = 250;         
