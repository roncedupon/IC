/**
 * Abstract:
 * This test is used to provide the usecase of EI "I2C_INSERT_P_AFTER_8_BIT_RD_DATA".
 * The EI is used to forcefully insert stop right after 8th bit of slave data for read.
 * The stop can be forced at any position within the data bytes using the variable "num_data_byte"
 * of the callback "i2c_master_insert_stop_after_8bit_of_read_data_byte_callback".
 * This test shows the stop insertion after the 4th byte of slave data.
 *
 */
...
`include "i2c_master_insert_stop_after_8bit_of_read_data_byte_callback.sv"

class i2c_master_insert_stop_after_8b_read_data_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(i2c_master_insert_stop_after_8b_read_data_test)

  i2c_master_insert_stop_after_8bit_of_read_data_byte_callback cust_callback;

  /** Class constructor */
  function new(string name = "i2c_master_insert_stop_after_8b_read_data_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    cust_callback.num_data_byte = 4; //provide the info after how many bytes stop needs to be inserted.
   ...
   function void connect_phase(uvm_phase phase);
     ...
     if(cfg.master_cfg[0].enable_i2c_data_port_with_ack_and_sr_p) env.sb.enable = 0;
