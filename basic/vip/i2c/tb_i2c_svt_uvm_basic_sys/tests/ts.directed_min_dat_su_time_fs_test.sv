...
class directed_min_dat_su_time_fs_test extends i2c_base_test;

  /** UVM component utility macro */
  `uvm_component_utils(directed_min_dat_su_time_fs_test)

  /** Class constructor */
  function new(string name = "directed_min_dat_su_time_fs_test", uvm_component parent=null);
