...
/**
 * Abstract:
 * axi_master_random_sequence is used by test to provide initiator scenario
...
`ifndef GUARD_AXI_MASTER_RANDOM_SEQUENCE_SV
`define GUARD_AXI_MASTER_RANDOM_SEQUENCE_SV
...
`endif // GUARD_AXI_MASTER_RANDOM_SEQUENCE_SV
