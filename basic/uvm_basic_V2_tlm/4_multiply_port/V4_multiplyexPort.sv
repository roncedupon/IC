...
class producer extends uvm_component;
    ...
    function new(string name="producer",uvm_component parent);
        ...
        put_port=new("put_port",this,1,1);//修改这里，
    ...
    virtual task run_phase(uvm_phase phase);
        ...
        phase.raise_objection(this);
            ...
            tr.a=id;
            put_port.put(tr);                
            $display("[%0d]tr has been put",$time);
...
class consumer extends uvm_component;
    ...
    function put(tlm_tr tr);//这里改了一下，验证连接多个port时是如何阻塞的

        $display("[%0d]put function id is %d",$time,tr.a);
    endfunction
...
class Myenv extends uvm_component;
    ...
    function new(string name="Myenv",uvm_component parent);
        ...
        producer1=producer::type_id::create("producer1",this);
    ...
    virtual function void connect_phase(uvm_phase phase);
        ...
        producer1.put_port.connect(consumer0.put_imp);//看这里，把port和imp进行了连接，现在没有export了
