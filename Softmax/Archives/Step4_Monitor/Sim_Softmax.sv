...
initial begin
    // run_test("my_dirver");
    uvm_config_db#(virtual mAxis)::set(null,"uvm_test_top.SoftMax_Driver","vif",input_if);//初始化interface
    uvm_config_db#(virtual sAxis)::set(null,"uvm_test_top.SoftMax_Monitor_Inst","vif",Stage1_output_if);//初始化interface
