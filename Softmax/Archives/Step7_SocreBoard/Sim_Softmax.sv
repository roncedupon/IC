...
initial begin
    // run_test("my_dirver");
    uvm_config_db#(virtual Axis)::set(null,"uvm_test_top.Stage1_FindMax_iAgent.SoftMax_Driver_Inst","vif",Stage1_input_if);//初始化interface
    uvm_config_db#(virtual Axis)::set(null,"uvm_test_top.Stage1_FindMax_iAgent.SoftMax_Monitor_Inst","vif",Stage1_input_if);//初始化interface
    uvm_config_db#(virtual Axis)::set(null,"uvm_test_top.Stage1_FindMax_oAgent.SoftMax_Monitor_Inst","vif",Stage1_output_if);//初始化interface
